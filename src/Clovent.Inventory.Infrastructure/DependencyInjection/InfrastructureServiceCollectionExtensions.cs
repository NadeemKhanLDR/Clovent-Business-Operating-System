...
/// <summary>Inventory's own Infrastructure-layer registration, following the AddApplication()/AddInfrastructure()/AddPersistence() convention. Holds the <see cref="UnitOfWorkBehavior{TRequest,TResponse}"/> MediatR pipeline registration.</summary>
