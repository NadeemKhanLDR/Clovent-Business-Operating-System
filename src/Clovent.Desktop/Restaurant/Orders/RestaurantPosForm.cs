...
public sealed partial class RestaurantPosForm : XtraForm
{
    ...
    private static void LogDesignerException(Exception ex, string context)
    {
        try
        {
            var logPath = @"d:\Clovent Business Operating System\designer_exception.txt";
    ...
    private void UpdateCategoryButtonSelection()
    {
        ...
        foreach (SimpleButton button in _categoryButtonsPanel.Controls)
        {
    ...
    private void UpdateButtonStates()
    {
        ...
        // Enable or disable the entire bottom payment bar:
        pnlPayment.Enabled = isOpen && Permit("pay");
